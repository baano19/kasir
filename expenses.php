        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $is_ed ? "<input type='text' name='cat' value='{$e["category"]}' style='width:70px'>" : $e["category"] ?></td>
                    <td><?= $is_ed ? "<input type='number' name='amt' value='{$e["amount"]}' style='width:70px'>" : number_format($e["amount"]) ?></td>
                    <td><?= $is_ed ? "<input type='text' name='note' value='{$e["notes"]}' style='width:80px'>" : ($e["name"] ?: 'Admin') . " - " . $e["notes"] ?></td>
                    <td>
                        <?php if($is_ed): ?>
